...
# ------------------------------------------------------------------
# Excel reconciliation for Joelle (MBR-0024)
...
DELTAS = [
    (2026,  1,    20000,   2000,   3000),
    (2026,  2,    20000,   2000,   3000),
    (2026,  3,    20000,   2000,   3000),
    (2026,  4,    20000,   2000,   3000),
    (2026,  5,    20000,   2000,   3000)
]
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('core', '0100_reconcile_contributions_mbr_0023'),
    ]
