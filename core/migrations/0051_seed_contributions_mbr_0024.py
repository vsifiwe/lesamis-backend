...
CONTRIBUTIONS = [
    ...
    (2023, 12,   40000, 4000, 6000),
    (2024,  2,   80000, 8000, 12000),
    (2024,  6,   60000, 6000, 9000),
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('core', '0050_seed_contributions_mbr_0023'),
    ]
