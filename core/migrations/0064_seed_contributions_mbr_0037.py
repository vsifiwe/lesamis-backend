...
MEMBER_NUMBER = 'MBR-0037'

# (year, month, capital, social, social_plus)
CONTRIBUTIONS = [
    (2023,  9,  100000,    0,    0),
    (2023, 10,   10000, 2000, 3000),
    (2023, 11,  430000, 32000, 3000),
    (2023, 12,   10000, 15000, 90000),
    (2024,  1,   10000, 30900, 3000),
    (2024,  2,   10000, 34100, 3000),
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('core', '0063_seed_contributions_mbr_0036'),
    ]
