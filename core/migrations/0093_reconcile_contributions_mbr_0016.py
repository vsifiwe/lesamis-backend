...
# ------------------------------------------------------------------
# Excel reconciliation for Tuyizere (MBR-0016)
...
DELTAS = [
    (2020,  8,        0,  28000,      0),
    (2026,  1,    30000,   2000,   3000),
    (2026,  2,    30000,   2000,   3000),
    (2026,  3,    30000,   2000,   3000),
    (2026,  4,    30000,   2000,   3000)
]
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('core', '0092_reconcile_contributions_mbr_0015'),
    ]
