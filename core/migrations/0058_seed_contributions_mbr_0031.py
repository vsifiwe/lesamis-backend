...
MEMBER_NUMBER = 'MBR-0031'

# (year, month, capital, social, social_plus)
CONTRIBUTIONS = [
    (2022,  3,   82000, 68000,    0),
    (2022,  4,  208000, 2000, 36000),
    (2022,  5,   70000, 2000, 3000),
    (2022,  6,  150000, 2000, 3000),
    (2022,  7,  150000, 2000, 3000),
    (2022,  8,  120000, 2000, 3000),
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('core', '0057_seed_contributions_mbr_0030'),
    ]
