...
MEMBER_NUMBER = 'MBR-0046'

# (year, month, capital, social, social_plus)
CONTRIBUTIONS = [
    (2024, 10,   90500,    0,    0),
    (2024, 11,  176100, 2000, 3000),
    (2024, 12,   10000, 45000, 126000),
    (2025,  1,  175000,    0, 6000),
    (2025,  2,   86000, 91000, 3000),
    (2025,  3,  176000, 2000, 3000),
    (2025,  4,    6400, 4000, 6000),
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('core', '0072_seed_contributions_mbr_0045'),
    ]
