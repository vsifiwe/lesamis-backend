...
# ------------------------------------------------------------------
# Excel reconciliation for Claudine M (MBR-0034)
...
DELTAS = [
    (2026,  1,    10000,   2000,   3000),
    (2026,  2,    10000,   2000,   3000),
    (2026,  3,    10000,   2000,   3000),
    (2026,  4,    10000,   2000,   3000),
    (2026,  5,    10000,   2000,   3000)
]
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('core', '0109_reconcile_contributions_mbr_0033'),
    ]
