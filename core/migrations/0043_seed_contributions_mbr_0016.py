...
CONTRIBUTIONS = [
    ...
    (2020, 12,   10000, 2000,    0),
    (2021,  1,  110000, 2000,    0),
    (2021,  2,  120000, 2000,    0),
    (2021,  3,   20000, 2000,    0),
    (2021,  4,   20000, 2000,    0),
    (2021,  5,   20000, 2000, 3000),
    (2021,  6,   20000, 2000, 3000),
    (2021,  7,   20000, 2000, 3000),
    (2021,  8,   20000, 2000, 3000),
    (2021,  9,   20000, 2000, 3000),
    (2021, 10,   20000, 2000, 3000),
    (2021, 11,  260000, 2000, 3000),
    (2022,  1,   20000, 2000, 3000),
    (2022,  2,   20000, 2000, 3000),
    (2022,  3,   20000, 2000, 3000),
    (2022,  4,  160000, 6000, 6000),
    (2022,  5,   30000, 2000, 3000),
    (2022,  6,   30000, 2000, 3000),
    (2022,  7,   30000, 2000, 3000),
    (2022,  8,   30000, 2000, 3000),
    (2022,  9,   30000, 2000, 3000),
    (2022, 10,   30000, 2000, 3000),
    (2022, 11,   30000, 2000, 3000),
    (2022, 12,   30000, 2000, 3000),
    (2023,  1,   30000, 2000, 3000),
    (2023,  2,   30000, 2000, 3000),
    (2023,  3,   30000, 2000, 3000),
    (2023,  4,   30000, 2000, 3000),
    (2023,  5,   30000, 2000, 3000),
    (2023,  6,   30000, 2000, 3000),
    (2023,  7,   30000, 2000, 3000),
    (2023,  8,   30000, 2000, 3000),
    (2023,  9,   30000, 2000, 3000),
    (2023, 10,   30000, 2000, 3000),
    (2023, 11,   30000, 2000, 3000),
    (2023, 12,   30000, 2000, 3000),
    (2024,  1,   30000, 2000, 3000),
    (2024,  2,   30000, 2000, 3000),
    (2024,  3,   30000, 2000, 3000),
    (2024,  4,   30000, 2000, 3000),
    (2024,  5,   30000, 2000, 3000),
    (2024,  6,   30000, 2000, 3000),
    (2024,  7,   30000, 2000, 3000),
    (2024,  8,   30000, 2000, 3000),
    (2024,  9,   30000, 2000, 3000),
    (2024, 10,   30000, 2000, 3000),
    (2024, 11,   30000, 2000, 3000),
    (2024, 12,   30000, 2000, 3000),
    (2025,  1,   30000, 2000, 3000),
    (2025,  2,   30000, 2000, 3000),
    (2025,  3,   30000, 2000, 3000),
    (2025,  4,   30000, 2000, 3000),
    (2025,  5,   30000, 2000, 3000),
    (2025,  6,   30000, 2000, 3000),
    (2025,  7,   30000, 2000, 3000),
    (2025,  8,   30000, 2000, 3000),
    (2025,  9,   30000, 2000, 3000),
    (2025, 10,   30000, 2000, 3000),
    (2025, 11,   30000, 2000, 3000),
    (2025, 12,   30000, 2000, 3000),
]
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('core', '0042_seed_contributions_mbr_0015'),
    ]
