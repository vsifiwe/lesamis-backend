...
CONTRIBUTIONS = [
    ...
    (2021,  1,  420000, 2000,    0),
    (2021,  2,   40000, 2000,    0),
    (2021,  3,   40000, 2000,    0),
    (2021,  4,   40000, 2000,    0),
    (2021,  5,   40000, 2000, 3000),
    (2021,  6,   40000, 2000, 3000),
    (2021,  7,   40000, 2000, 3000),
    (2021,  8,   40000, 2000, 3000),
    (2021,  9,   40000, 2000, 3000),
    (2021, 10,   40000, 2000, 3000),
    (2021, 11,   40000, 2000, 3000),
    (2021, 12,   40000, 2000, 3000),
    (2022,  1,   40000, 2000, 3000),
    (2022,  2,   40000, 2000, 3000),
    (2022,  3,   40000, 2000, 3000),
    ...
    (2022, 10,   40000, 2000, 3000),
    (2022, 11,   40000, 2000, 3000),
    ...
    (2023, 12,   40000, 2000, 3000),
    (2024,  1,   40000, 2000, 3000),
    (2024,  2,   40000, 2000, 3000),
    (2024,  3,   40000, 2000, 3000),
    (2024,  4,   40000, 2000, 3000),
    (2024,  5,   40000, 2000, 3000),
    (2024,  6,   40000, 2000, 3000),
    (2024,  7,   40000, 2000, 3000),
    (2024,  8,   40000, 2000, 3000),
    (2024,  9,   40000, 2000, 3000),
    (2024, 10,   40000, 2000, 3000),
    (2024, 11,   80000, 4000, 6000),
    (2025,  1,   40000, 2000, 3000),
    (2025,  2,   40000, 2000, 3000),
    (2025,  3,   40000, 2000, 3000),
    (2025,  4,  750000, 2000, 3000),
    (2025,  5,   50000, 2000, 3000),
    (2025,  6,   50000, 2000, 3000),
    (2025,  7,   50000, 2000, 3000),
    (2025,  8,   50000, 2000, 3000),
    (2025,  9,   50000, 2000, 3000),
    (2025, 10,   50000, 2000, 3000),
    (2025, 11,   50000, 2000, 3000),
    (2025, 12,   50000, 2000, 3000),
]
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('core', '0029_seed_contributions_mbr_0002'),
    ]
