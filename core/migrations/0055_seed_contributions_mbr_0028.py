...
MEMBER_NUMBER = 'MBR-0028'

# (year, month, capital, social, social_plus)
CONTRIBUTIONS = [
    (2021,  9,   56000, 44000, 15000),
    (2021, 10,   48000, 14000, 3000),
    (2021, 11,  206000, 4000, 6000),
    (2022,  1,   20000, 4000, 6000),
    ...
    (2022, 10,   20000, 4000, 6000),
    (2022, 12,   20000, 4000, 6000),
    ...
    (2025,  5,   70000, 12000, 18000),
    (2025, 10,   10000, 4000, 6000),
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('core', '0054_seed_contributions_mbr_0027'),
    ]
