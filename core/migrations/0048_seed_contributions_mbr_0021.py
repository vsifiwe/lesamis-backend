...
MEMBER_NUMBER = 'MBR-0021'

# (year, month, capital, social, social_plus)
CONTRIBUTIONS = [
    (2021,  6,   50000, 50000,    0),
    (2021,  7,  110000, 2000, 6000),
    (2021,  8,  110000, 2000, 6000),
    ...
    (2025,  5,  150000, 2000, 3000),
    (2025,  6,  160000, 2000, 3000),
    (2025,  7,  160000, 2000, 3000),
    (2025,  8,  160000, 2000, 3000),
    (2025,  9,   20000, 2000, 3000),
    (2025, 10,  180000, 4000, 6000),
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('core', '0047_seed_contributions_mbr_0020'),
    ]
