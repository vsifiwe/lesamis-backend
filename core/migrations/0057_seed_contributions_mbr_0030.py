...
MEMBER_NUMBER = 'MBR-0030'

# (year, month, capital, social, social_plus)
CONTRIBUTIONS = [
    (2021,  9,   94000, 56000, 15000),
    (2021, 10,   10000, 2000, 3000),
    (2021, 11,  196000, 2000, 3000),
    ...
    (2022,  9,  160000, 32000, 48000),
    (2024,  1,  120000, 24000, 36000),
    (2025,  1,  120000, 24000, 36000),
]
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('core', '0056_seed_contributions_mbr_0029'),
    ]
