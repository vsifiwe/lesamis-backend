...
MEMBER_NUMBER = 'MBR-0011'

# (year, month, capital, social, social_plus)
CONTRIBUTIONS = [
    (2020,  8,  150000, 2000,    0),
    (2020,  9,   10000, 2000,    0),
    ...
    (2022,  1,  210000, 2000, 3000),
    (2022,  2,  210000, 2000, 3000),
    (2022,  3,  220000, 2000, 3000),
    (2022,  4,   50000, 2000, 3000),
    (2022,  5,   80000, 2000, 3000),
    ...
    (2023,  7,   60000, 4000, 6000),
    (2023,  9,   60000, 4000, 6000),
    (2023, 11,  180000, 12000, 18000),
    (2024,  4,   90000, 6000, 9000),
    (2024,  8,   30000, 2000, 3000),
    (2024,  9,   30000, 2000, 3000),
    (2024, 10,   90000, 6000, 9000),
    (2025,  1,   30000, 2000, 3000),
    (2025,  2,   30000, 2000, 3000),
    (2025,  3,   30000, 2000, 3000),
    (2025,  4,   30500, 2000, 3000),
    (2025,  5,   90000, 6000, 9000),
    (2025,  8,   60000, 4000, 6000),
    (2025,  9,   30000, 2000, 3000),
    (2025, 10,   60000, 4000, 6000),
]
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('core', '0037_seed_contributions_mbr_0010'),
    ]
