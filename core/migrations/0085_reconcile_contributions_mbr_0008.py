...
# ------------------------------------------------------------------
# Excel reconciliation for Vanessa (MBR-0008)
...
DELTAS = [
    ...
    (2026,  2,   120000,   2000,   3000),
    (2026,  3,   100000,   2000,   3000),
    (2026,  4,   100000,   2000,   3000),
    (2026,  5,   100000,   2000,   3000)
]
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('core', '0084_reconcile_contributions_mbr_0007'),
    ]
